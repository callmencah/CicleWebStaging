...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            # Create Card,Add Label, Change Colour Label.
            # ----------------------------------------------------------------------------------------------------------
            # Login
            ...
            sb.wait_for_element('//*[@id="root"]/div[3]/div[4]/a/div/div[1]/p')
            ...
            sb.click('/html/body/div[5]/div/div/div[2]/div/div/div[2]/div[1]/div[2]/div/div[5]/div[23]')
            sb.click('/html/body/div[5]/div/div/div[2]/div/div/div[2]/div[1]/div[2]/div/div[5]/div[23]')
            sb.click('//*[@class="btn btn-success btn-sm"]')
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[6]/button/div/h1')
            sb.save_screenshot("Change Colour Label", "Custom_Screenshots")
            sb._print("Success Change Colour Label")
