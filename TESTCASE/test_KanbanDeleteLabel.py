...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            # Create Card,Add Label, Delete Label.
            # ----------------------------------------------------------------------------------------------------------
            # Login
            ...
            sb.click('/html/body/div[5]/div/div/div[2]/div/div/div[2]/div[1]/div[2]/div/div[5]/div[1]')
            sb.click('/html/body/div[5]/div/div/div[2]/div/div/div[2]/div[1]/div[2]/div/div[5]/div[1]')
            sb.click('//*[@class="btn btn-danger btn-sm"]')
            sb.click('//*[@class="btn btn-danger btn-sm"]')
            sb.refresh()
            sb.save_screenshot("Delete Label", "Custom_Screenshots")
            sb._print("Success Delete Label")