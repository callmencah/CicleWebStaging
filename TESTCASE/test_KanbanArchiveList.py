...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            sb.click('//*[@id="root"]/div/div[3]/div/div/div[1]/div/div/div[1]/div[2]/div[2]/div[3]/div/div/div[2]/p')
            sb.save_screenshot("Archive This List", "Custom_Screenshots")
            sb._print("Success Archive This List")
            # ----------------------------------------------------------------------------------------------------------
