...
class aduhTest(BaseCase):
    def test_aduh(sb):
        with SB(uc=True) as sb:
            # ----------------------------------------------------------------------------------------------------------
            # Login, Create Company, Company Same Name, Company Null
            # ----------------------------------------------------------------------------------------------------------
            # Login
            ...
            # ----------------------------------------------------------------------------------------------------------
            # Company Same Name
            sb.click('.NavIcon_back__17EAr')
            sb.click('.HeaderSwitchCompany_plusButton__3_-rt')
            sb.type('input[name="name"]', "Company1")
            sb.type('//*[@id="companyDesc"]', "Company1")
            sb.click('.Button_container__1WNuB')
            sb.save_screenshot("Company Same Name", "Custom_Screenshots")
            # ----------------------------------------------------------------------------------------------------------
            # Company Null
            sb.click('.NavIcon_back__17EAr')
            sb.click('.HeaderSwitchCompany_plusButton__3_-rt')
            sb.click('.Button_container__1WNuB')
            sb.save_screenshot("Company Null", "Custom_Screenshots")