...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            sb.wait_for_element('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[4]/div')
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[4]/div')
            sb.type('//*[@placeholder="Input name"]', "Second Label")
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[5]/div[2]')
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[6]/button/div')
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[5]/div[2]/div/div')
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[6]/button/div/h1')
            sb.wait_for_element('//*[@id="root"]/div/div[3]/div/div/div[2]/button/div/div/a')
            sb.save_screenshot("Add Another Label", "Custom_Screenshots")
            sb._print("Success Add Another Label")
