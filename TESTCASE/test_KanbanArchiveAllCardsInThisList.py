...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            # Create Private Card With Same Name, Archive All Cards in This List.
            # ----------------------------------------------------------------------------------------------------------
            # Login
            ...
            sb.click('//*[@id="root"]/div/div[3]/div/div/div[1]/div/div/div[1]/div[2]/div[2]/div[3]/div/div/div[1]/p')
            sb.save_screenshot("Archive All Cards in This List", "Custom_Screenshots")
            sb._print("Success Archive All Cards in This List")
            # ----------------------------------------------------------------------------------------------------------
