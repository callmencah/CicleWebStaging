...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            # Create Card, Add Notes, Change Notes.
            # ----------------------------------------------------------------------------------------------------------
            # Login
            ...
            # ----------------------------------------------------------------------------------------------------------
            # Add Notes
            sb.click('//*[@id="cardModal"]/div/div/div[1]/div[4]/div[2]/div/p')
            sb.type('/html/body/div[5]/div/div/div[2]/div/div/div[1]/div[4]/div[2]/div/div[1]/div/div[2]/div/p', "Add Notes")
            sb.click('//*[@class="btn btn-success btn-sm"]')
            sb.click('//*[@class="close"]')
            sb.save_screenshot("Add Notes", "Custom_Screenshots")
            sb._print("Success Add Notes")
            # ----------------------------------------------------------------------------------------------------------
            # Navigate To Card Page
            ...
            # ----------------------------------------------------------------------------------------------------------
            # Change Notes
            sb.double_click('//*[@class="ManageDesc_editIcon__1I0bY"]')
            sb.click('//*[@class="fr-element fr-view"]')
            sb.type('//*[@class="fr-element fr-view"]',
                    "Change Notes")
            sb.click('//*[@class="btn btn-success btn-sm"]')
            sb.save_screenshot("Change Notes", "Custom_Screenshots")
            sb._print("Success Change Notes")
