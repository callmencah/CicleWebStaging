...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            # Create Card, Add Notes, Set Due Date, Change Due Date, Delete Due Date.
            # ----------------------------------------------------------------------------------------------------------
            # Login
            ...
            # ----------------------------------------------------------------------------------------------------------
            # Set Due Date
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[3]')
            sb.click('//*[@class="btn btn-success btn-sm"]')
            sb.click('//*[@class="close"]')
            sb.save_screenshot("Set Due Date", "Custom_Screenshots")
            sb._print("Success Set Due Date")
            # ----------------------------------------------------------------------------------------------------------
            # Navigate To Card Page
            ...
            # ----------------------------------------------------------------------------------------------------------
            # Change Due Date
            sb.click('//*[@class="DateBox_DateBox__3UL8M"]')
            sb.click('//*[@placeholder="yyyy/mm/dd"]')
            sb.type('//*[@placeholder="yyyy/mm/dd"]', "2023/03/30")
            sb.click('//*[@class="btn btn-success btn-sm"]')
            sb.save_screenshot("Change Due Date", "Custom_Screenshots")
            sb._print("Success Change Due Date")
            # ----------------------------------------------------------------------------------------------------------
            # Delete Due Date
            sb.click('//*[@class="DateBox_DateBox__3UL8M"]')
            sb.click('//*[@class="btn btn-danger btn-sm"]')
            sb.save_screenshot("Delete Due Date", "Custom_Screenshots")
            sb._print("Success Delete Due Date")
