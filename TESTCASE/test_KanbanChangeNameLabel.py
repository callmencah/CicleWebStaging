...
from selenium.webdriver.common.devtools.v108.dom_snapshot import Rectangle
...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            # Create Card,Add Label. Change Name Label
            # ----------------------------------------------------------------------------------------------------------
            # Login
            ...
            sb.save_screenshot("Login", "Custom_Screenshots")
            ...
            sb.save_screenshot("Create Board List", "Custom_Screenshots")
            sb._print("Success Create Board List")
            # ----------------------------------------------------------------------------------------------------------
            # Create Card
            ...
            # ----------------------------------------------------------------------------------------------------------
            # Add Label
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/button/div')
            sb.wait_for_element('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[4]/div')
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[4]/div')
            sb.type('//*[@placeholder="Input name"]', "First Label")
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[5]/div[1]')
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[6]/button/div')
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[5]/div/div/div')
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[6]/button/div/h1')
            sb.click('/html/body/div[5]/div/div/div[1]/button/span[1]')
            sb.save_screenshot("Add Label", "Custom_Screenshots")
            sb._print("Success Add Label")
            # ----------------------------------------------------------------------------------------------------------
            # Navigate To Card Page
            sb.hover_and_click('//*[@id="listcard_content-0"]/div[1]/div/div/a',
                               '//*[@id="listcard_content-0"]/div[1]/div/div/a')
            sb.wait_for_element('//*[@id="cardModal"]/div/div/div[1]/div[4]/div[2]/div/p')
            sb.save_screenshot("Navigate To Card Page", "Custom_Screenshots")
            sb._print("Success Navigate To Card Page")
            # ----------------------------------------------------------------------------------------------------------
            ...
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/button/div')
            sb.wait_for_element('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[4]/div')
            sb.click('//*[@class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium ToggleLabels_ToggleLabelsContainer__editIcon__3v47q css-vubbuv"]')
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[3]/form/input')
            sb.type('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[3]/form/input', "Change Label")
            sb.click('//*[@id="cardModal"]/div/div/div[2]/div[1]/div[2]/div/div[6]/button[1]')
            sb.click('/html/body/div[5]/div/div/div[1]/button/span[1]')
            sb.save_screenshot("Change Name Label", "Custom_Screenshots")
            sb._print("Success Change Name Label")
