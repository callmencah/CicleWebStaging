...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            # Create Private Card, Archive Private Card.
            # ----------------------------------------------------------------------------------------------------------
            # Login
            ...
            sb.click('//*[@id="editCardMenuButton__Archive__text"]')
            sb.save_screenshot("Archive Private Card", "Custom_Screenshots")
            sb.wait_for_element('//*[@id="root"]/div/div[3]/div/div/div[1]/div/div/div[4]/a')
            sb._print("Success Archive Private Card")
