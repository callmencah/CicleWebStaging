...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            # ----------------------------------------------------------------------------------------------------------
            # Edit Comment
            sb.click('//*[@class="More_container__2VGML"]')
            sb.click('//*[@class="Item_icon__1ol20 Item_iconDefault__3jBgF"]')
            sb.click('/html/body/div[5]/div/div/div[2]/div/div/div[1]/div[7]/div/div/div/div[4]/div/div[2]/div[3]/div/div[1]/div/div/div[2]/div/p')
            sb.type('/html/body/div[5]/div/div/div[2]/div/div/div[1]/div[7]/div/div/div/div[4]/div/div[2]/div[3]/div/div[1]/div/div/div[2]/div/p', "Edit Comment")
            sb.click('//*[@class="Main_iconText__f-xVC Main_iconDefault__3fDo9 Main_iconPositionStart__IWQqT"]')
            sb.save_screenshot("Edit Comment", "Custom_Screenshots")
            sb._print("Success Edit Comment")
