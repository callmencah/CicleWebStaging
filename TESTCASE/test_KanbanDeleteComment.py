...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            sb.click('//*[@class="Item_icon__1ol20 Item_iconDanger__2sZmS"]')
            sb.click('//*[@class="Main_iconText__f-xVC Main_iconDanger__LRdQD Main_iconPositionStart__IWQqT"]')
            sb.refresh()
            sb.click('//*[@class="close"]')
            sb.save_screenshot("Delete Comment", "Custom_Screenshots")
            sb._print("Success Delete Comment")
