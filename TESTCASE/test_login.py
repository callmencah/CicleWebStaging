...
class aduhTest(BaseCase):
    def test_aduh(sb):
        with SB(uc=True) as sb:
            ...
            # sb.print("Create Company Success")
            # -----------------------------------------------------------------------------------------------------------------------
            ...
            # sb.print("Create Team Success")
            sb.click('.Card_text__22WoI')
            sb.save_screenshot("Navigate To Overview Page", "Custom_Screenshots")
            sb.click('//*[@src="/static/media/board.82e692f2.png"]')
            sb.save_screenshot("Navigate To Board Page", "Custom_Screenshots")
