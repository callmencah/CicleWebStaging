...
class CreateTeamTest(BaseCase):
    def test_create_team(sb):
        with SB(uc=True) as sb:
            ...
            # Add Another  Comment
            sb.click('//*[@placeholder="Add new comment..."]')
            sb.type('//*[@id="cardModal"]/div/div/div[1]/div[7]/div/div/div/div[2]/div[2]/div[1]/div/div/div[2]/div/p', "Add Another Comment")
            sb.click('//*[@class="Main_iconText__f-xVC Main_iconDefault__3fDo9 Main_iconPositionStart__IWQqT"]')
            sb.save_screenshot("Add Another Comment", "Custom_Screenshots")
            sb._print("Success Add Another Comment")